...
**Degree:** 90 ECTS | Duration: 1.5 academic years (3 semesters)  
...
- `curriculum/semester-1/` — markdown files for each course in Semester 1  
- `curriculum/semester-2/` — markdown files for Semester 2  
- `curriculum/semester-3/` — markdown files for Semester 3 including thesis overview  
- `resources/` — recommended books, papers, tools & libraries  
- `projects/` — code samples or hands-on work (if any)  
- `README.md`, `LICENSE.md`, `CONTRIBUTING.md` — base files  
